...
- [All generated output must follow the rules set here with no deviation.](#all-generated-output-must-follow-the-rules-set-here-with-no-deviation)
...
version: 1.1.0
last_updated: 2025-04-06
ref: agent-instructions/prompts/uds-generation-prompt.md
authors:
